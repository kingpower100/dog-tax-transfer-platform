...
Original URL: https://gemini.google.com/app/b8c1c3747c078dd5

**[USER]**
Tell me more about the EU : The Once-Only principle: towards a usercentric and agile public administration

**[ASSISTANT]**
The **Once-Only Principle (OOP)** is a cornerstone of the European Union's digital strategy. It aims to transform how public administrations interact with citizens and businesses by ensuring that they are only asked to provide information to a public authority **once**.

Instead of you having to resubmit the same birth certificate, diploma, or company registration every time you deal with a different government department (or a government in a different EU country), the authorities themselves take the responsibility of sharing and reusing that data securely.

### 1\. The Core Philosophy: User-Centricity

Traditional bureaucracy is often "administration-centric," meaning the citizen must navigate the internal silos of the government. The Once-Only principle flips this, moving toward a **user-centric** model:

-   **Reduction of Administrative Burden:** Citizens and businesses save time and money by not having to gather, photocopy, and mail documents that the government already possesses.
    
-   **Data Sovereignty:** Users remain in control. Under EU rules (like the GDPR), the data exchange usually happens only at the user's explicit request or with their consent.
    
-   **Proactive Services:** In a truly agile administration, the "Once-Only" data can allow the government to offer services proactively (e.g., automatically notifying a family they are eligible for a child benefit because the birth is already registered in the system).
    

### 2\. The Engine: The Once-Only Technical System (OOTS)

To make this work across all 27 EU Member States, the EU launched the **Once-Only Technical System (OOTS)** in December 2023. It is part of the **Single Digital Gateway**, which you might know through the **"Your Europe"** portal.

-   **How it works:** When you apply for something online (like a study grant in another country), the portal gives you an option to "Retrieve Evidence." The OOTS then securely fetches the required document directly from the issuing authority in your home country and delivers it to the requesting authority in the host country.
    
-   **No Central Database:** Crucially, the EU does not store all this data in one giant central "super-database." Instead, the OOTS is a decentralized "connector" that links existing national databases only when a request is made.
    

### 3\. Towards an "Agile" Public Administration

The Once-Only principle is a catalyst for making governments more agile and modern:

-   **Interoperability:** For data to flow between a tax office in Spain and a university in Germany, systems must speak the same digital language. This forces administrations to adopt common standards and open APIs.
    
-   **Cross-Border Mobility:** It removes one of the biggest "invisible walls" in the EU Single Market. It makes moving, studying, or starting a business in another Member State as easy as doing it at home.
    
-   **Efficiency for the State:** It reduces manual data entry, minimizes errors, and helps prevent fraud, as the data comes directly from a "trusted source" rather than a potentially forged paper document.
    

### 4\. Key Areas of Application

The principle is currently being rolled out across 21 specific procedures mandated by EU law, including:

-   **Education:** Requesting recognition of diplomas or applying for study grants.
    
-   **Business:** Registering a company, notifying changes in business activity, or claiming social security for employees.
    
-   **Personal Life:** Registering a birth, changing a permanent address, or registering a vehicle.
    

### Summary of Benefits

| Benefit | For Citizens                                       | For Businesses                                       | For Administrations                           |
| ------- | -------------------------------------------------- | ---------------------------------------------------- | --------------------------------------------- |
| Time    | No more searching for old paperwork.               | Faster permits and licenses.                         | Less manual verification of documents.        |
| Cost    | No more fees for certified copies or translations. | Estimated €11 billion/year in savings across the EU. | Lower administrative processing costs.        |
| Trust   | Transparency on who uses their data.               | Increased legal certainty.                           | Direct access to authentic, fraud-proof data. |
|         |                                                    |                                                      |                                               |
**[USER]**
Tell me more about the EU : The Once-Only principle: towards a usercentric and agile public administration
...
**[USER]**
I am a bit lost. What is the MVP that I need to develop do.   Act as third-party SaaS between the citizen and municipalities,? or it's a saas provided for all municipalities, to manager citizen request?   I thought I need to develop a SaaS (business idea) that citizen uses and has the goverment teck (simulate the tech: BundID, FIT-Connect, OOTS APIs, and eDelivery). So it communicate with municipalities using Tech in Germany and no other way. What did I get wrong and why do you think so?

**[ASSISTANT]**
You aren’t wrong—you’ve actually hit on the most ambitious and "correct" version of this business. The reason it feels confusing is that you are building a bridge where one side is a **consumer app** (modern, fast) and the other is a **fortress** (secure, bureaucratic).

Let’s clear the air on what your MVP actually is and how it functions as a business.

* * *

## 🧭 The "Reality Check": Two Paths for Your Business

In the German GovTech market of 2026, you have two ways to position your SaaS. You need to decide which one you are:

### Path A: The "Government Face" (B2G - Business to Government)

-   **The Vision:** You build the most beautiful dog registration website in the world. You sell this software to the **City of Leverkusen**.
    
-   **How it works:** Leverkusen puts a link on their official homepage: *"Click here to use our new Digital Pet Assistant."*
    
-   **The Tech:** You are "whitelabel." The citizen thinks they are using a city tool, but it's your code running the show. You use their **FIT-Connect** credentials.
    
-   **Revenue:** The municipality pays you a monthly license fee.
    

### Path B: The "Citizen’s Agent" (B2C - Business to Citizen)

-   **The Vision:** You build an app called "PetPass." Citizens download it to manage all their pet's legal needs across any city in Germany.
    
-   **How it works:** The citizen logs into **your** app. You use their **BundID** to prove who they are, and then **your** app talks to the municipality via **FIT-Connect** on the citizen's behalf.
    
-   **The Tech:** You act as a "Third-Party Sender."
    
-   **Revenue:** The citizen might pay a small fee, or you offer value-adds (like pet insurance).
    

> **What you got "right":** You correctly identified that the communication **must** happen via BundID, FIT-Connect, and OOTS. In 2026, German authorities are moving away from "email/PDF" and will eventually *only* accept data that comes through these secure "pipes."

* * *

## 🛠️ What Your MVP Does (The Step-by-Step)

To be a successful "Third-Party SaaS," your MVP must perform these **four specific actions** using the tech stack we discussed:

1.  **Identity Gatekeeper (BundID):** Your app has a "Login with BundID" button. You don't store their ID card; you just get a "token" from the government saying, *"Yes, this is Max Mustermann."*
    
2.  **Evidence Fetcher (OOTS/NOOTS):** Your app asks the user: *"We see you moved from Hannover. Want us to grab your dog's history automatically?"* Your app triggers the **OOTS/NOOTS** request. The data flows from Hannover’s registry to your app’s form.
    
3.  **The Translator (XÖV/JSON):** This is your "secret sauce." You take the user's input and turn it into the highly complex, encrypted **JWE (JSON Web Encryption)** package that the government's backend requires.
    
4.  **The Postman (FIT-Connect):** Your app looks up the **Routing API** to find where the dog-tax office in Leverkusen is. It then "drops" the encrypted package into the FIT-Connect Gateway.
    

* * *

## ⚠️ Why You Might Feel Lost (The "Certificates" Problem)

Here is the one thing you might have missed: **You cannot just "plug in" to the real German government network today without a certificate.**

To use the **Real** FIT-Connect or BundID:

-   You need a **V-PKI Certificate** (Verwaltung-Public Key Infrastructure).
    
-   In 2026, getting this usually requires you to be a "certified IT service provider."
    

**The Solution for your MVP:** You build your SaaS using the **FIT-Connect Test Environment (Sandbox)**. It behaves exactly like the real thing, but you don't need the high-level security clearance yet. You "simulate" the tech by using the official **Test-Gateways**.

* * *

## 📋 Summary: What should you build first?

Don't build a management tool for municipalities. **Build a "Transaction Portal" for citizens.**

1.  **Frontend:** A mobile-friendly web app where I can register my dog.
    
2.  **Backend:** A "Connector" that:
    
    -   Authenticates via a **Mock BundID**.
        
    -   Fetches data via the **OOTS Sandbox**.
        
    -   Sends a JSON payload to a **FIT-Connect Test Destination**.
        
3.  **The "Wow" Factor:** Show the user a "Live Status" bar that moves from "Submitted" to "Received" to "Approved" (even if the 'Approved' is a simulated response for now).
    

**The Business Value:** You go to a mayor and say: *"Look, I have a fully functional bridge. It handles all the OZG (Online Access Act) requirements. If you give me your Destination ID, I can turn this on for your city tomorrow."*

Does this help you see your position in the "middle" of the chain, or are you still wondering how you get paid for this service?

**[USER]**
So is it more Path A: The "Government Face" (B2G - Business to Government) than Path B: The "Citizen’s Agent" (B2C - Business to Citizen)?

**[ASSISTANT]**
The short answer is: **It is a Path A business (B2G) with a Path B (B2C) philosophy.**

In the German "GovTech" market of 2026, you are essentially building a **user-centric bridge** that municipalities buy to fix their outdated systems. While you want the citizen to have a seamless experience (Path B), your customer—the one who pays the bills and grants you access to the "pipes"—is almost certainly the government (Path A).

Here is why your MVP sits at this intersection and how to navigate it:

* * *

### 🏛️ Why it is mostly Path A (Business to Government)

Even if you build the most beautiful app, you cannot "plug in" to the German administrative network (FIT-Connect) or the identity network (BundID) in a vacuum.

1.  **The "Recipient" Bottleneck:** You are sending sensitive citizen data to a municipality. That municipality must **authorize you** as a valid sender. It is much easier to get this authorization if they are your *client* and you are providing them with a modern front-end for their citizens.
    
2.  **The Certificate (V-PKI):** In 2026, to use the production environment of FIT-Connect, you need a high-level security certificate. Usually, these are issued to authorities or their "designated IT service providers."
    
3.  **Revenue:** German citizens are historically reluctant to pay for government-related apps. However, municipalities are currently under **legal pressure (OZG 2.0)** to provide digital services like pet registration. They have the budget; the citizens don't.
    

### 🐕 Why it feels like Path B (The "Citizen's Agent")

You are designing the app *as if* it were a private consumer product (like Uber or Revolut). This is your **competitive advantage**.

-   **User-Centricity:** Government portals are often designed around laws; your MVP is designed around the **Life Event** (moving with a dog).
    
-   **Frictionless UX:** By integrating **OOTS/NOOTS**, you eliminate the need for the user to upload PDFs or type their address.
    
-   **The EUDI Wallet Synergy:** Since the EU Digital Identity Wallet is rolling out by late 2026, a citizen can "share" their residence proof with your app in two clicks. You are building the interface that makes this possible.
    

* * *

### 🛠️ The Hybrid Reality: How you actually build it

To be successful, your MVP should be marketed as a **"White-Label Municipal Connector."**

| Step | How it works in your MVP | The Tech Channel |
| --- | --- | --- |
| Login | Citizen sees "Login with BundID" on the city website. | BundID / eIDAS |
| Data | Your app asks: "We see you moved from Berlin. Transfer dog data?" | NOOTS / OOTS |
| Submit | Your app encrypts the data into the mandatory XÖV format. | End-to-End Encryption |
| Pipe | You "drop" the package into the municipality's inbox. | FIT-Connect |

### 🚀 What you got "Right" vs. What to Adjust

-   **Right:** You identified that communication **must** happen via these official tech channels. In 2026, an app that just sends an email to the city is considered "legacy" and will be ignored.
    
-   **Adjust:** Don't think of your app as a "third party" that works *despite* the government. Think of it as a **"Modern Front-End-as-a-Service"** that works *for* the government.
    

**My Advice for your MVP Strategy:** Target the **IT Service Providers** (like *AKDB* in Bavaria or *IT.NRW*). These giant entities handle the tech for thousands of smaller municipalities. If you convince *one* IT provider to offer your "Dog Registration Kit" as an add-on to their catalog, you instantly get access to hundreds of cities at once.

**Would you like me to help you draft the "Elevator Pitch" for a German Mayor to explain why your "Path B" interface is the solution to their "Path A" problem?**

**[USER]**
can you describe how the municipalities will handle the citizen request after the submission. for example, transfer from one to another city.

**[ASSISTANT]**
In 2026, the moment a citizen clicks "Submit" in your MVP, a sophisticated backend process begins. This process is designed to be invisible to the user but highly structured for the authorities.

Here is how the municipality (e.g., the "Receiving City" like **Leverkusen**) handles a dog transfer from a "Previous City" (e.g., **Hannover**).

* * *

## 🏎️ Phase 1: Ingestion (The Technical Receipt)

Once the submission leaves your MVP, it doesn't just sit in an email inbox. It enters the **FIT-Connect** infrastructure.

1.  **The Pickup:** The specialized backend software used by the city of Leverkusen (called a *Fachverfahren*) is constantly "polling" the FIT-Connect Gateway. It sees a new submission with the **Leika-Key** for dog registration.
    
2.  **Decryption:** The software uses the municipality’s private key to decrypt the "Fachdaten" (the JSON data your MVP sent).
    
3.  **Automatic Verification:** The system checks if the **BundID** token is valid, confirming that the person is who they say they are.
    

* * *

## 🏛️ Phase 2: The "Once-Only" Fetch (NOOTS)

This is the most critical step for your "Ummeldung" (transfer) use case. Instead of the clerk calling Hannover or asking the citizen for a "deregistration certificate," the system uses **NOOTS**.

1.  **Evidence Request:** Leverkusen's system sees that the dog was previously registered in Hannover (based on your MVP's data). It sends a request to the **NOOTS Mediation Service**.
    
2.  **The Pull:** NOOTS connects to Hannover’s local pet registry. It asks: *"Is dog chip #2760... registered to Max Mustermann? Has the tax been paid?"*
    
3.  **The Evidence:** Hannover’s system automatically replies via NOOTS with a digital "Proof of Deregistration."
    
4.  **Result:** The clerk in Leverkusen now sees a "Pre-Verified" application on their screen.
    

* * *

## ✍️ Phase 3: The Clerk's Action

The human element remains, but the task is now "Review" rather than "Data Entry."

-   **The Workflow:** The clerk opens their internal dashboard. Your submission is already formatted into their specific database fields (thanks to the **XÖV Standards**).
    
-   **Validation:** The clerk checks if the breed is allowed (e.g., checking against the "List of Dangerous Dogs" for that specific state).
    
-   **Approval:** With one click, the clerk approves the registration. This action triggers two simultaneous events:
    
    1.  A new **Tax ID** is generated for the dog in Leverkusen.
        
    2.  A **Digital Tax Assessment** (*Hundesteuerbescheid*) is created as a PDF.
        

* * *

## 🛰️ Phase 4: Closing the Loop (Status Update)

The municipality now sends information back to your MVP via the **FIT-Connect Reply Channel**.

1.  **Status Update:** The status changes to `COMPLETED` in the FIT-Connect Event Log.
    
2.  **The "Tax Letter":** The system uploads the digital tax assessment.
    
3.  **Notification:** Your MVP’s backend detects the new "Reply" and sends a push notification to the citizen: *"Welcome to Leverkusen! Your dog is registered. Your tax assessment is ready in your vault."*
    

* * *

## 🔄 Summary: The Transfer Lifecycle

| Action | Current (Old) Way | Your MVP (2026 Way) |
| --- | --- | --- |
| Deregistration | Citizen mails a form to City A. | Happens automatically via NOOTS. |
| Registration | Citizen goes to City B in person. | Happens via your MVP (FIT-Connect). |
| Verification | Clerks call each other or ask for paper. | Machine-to-machine data exchange. |
| Confirmation | Paper letter arrives 3 weeks later. | Digital PDF in your app within days. |

### What can go wrong in this phase?

-   **Data Inconsistency:** If Hannover’s registry has a different chip number than what the user typed in your MVP, NOOTS will return an error. Your MVP should handle this by asking the user to double-check their pet's ID or upload a photo of the chip certificate as "Manual Evidence."
    
-   **Missing Payment:** If the citizen owes back-taxes in the previous city, Hannover might "flag" the transfer in the NOOTS response.
    

Does this backend "handshake" between the two cities clarify how your SaaS acts as the initiator of a much larger, automated conversation?